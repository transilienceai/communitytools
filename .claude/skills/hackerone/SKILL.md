...
Per OUTPUT_STANDARDS.md - Bug Bounty format:
...
Uses `/pentest` skill and Pentester agent. Follows OUTPUT_STANDARDS.md for submission format. See `reference/HACKERONE_GUIDELINES.md` for platform-specific requirements.
