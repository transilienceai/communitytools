...
See `reference/TECHNIQUES.md` for complete payloads.
...
Integrates with `/pentest` skill. AI-specific vulnerability knowledge in `/AGENTS.md`. Agent workflows in `agents/`. See `reference/AGENT_DEPLOYMENT.md` for orchestration patterns.

## Reference

- [TECHNIQUES.md](reference/TECHNIQUES.md) - Complete payload catalog
- [AGENT_DEPLOYMENT.md](reference/AGENT_DEPLOYMENT.md) - Orchestration patterns
- [OWASP_MAPPING.md](reference/OWASP_MAPPING.md) - Vulnerability descriptions
