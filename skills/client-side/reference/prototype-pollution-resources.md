...
- **Author:** James Kettle, security researcher
- **Link:** [Security Research](https://portswigger.net/research/server-side-prototype-pollution)
- **Key Contributions:**
...
- **Documentation:** [Burp DOM Invader](https://portswigger.net/burp/documentation/desktop/tools/dom-invader/prototype-pollution)
- **Features:**
...
**James Kettle (security researcher):**
...
1. **Official Documentation** - Research references, OWASP, standards
