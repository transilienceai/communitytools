...
**For comprehensive SQL injection documentation, see [sql-injection.md](./sql-injection.md)**
...
**Key Resources:**
- [Comprehensive SQL Injection Reference](./sql-injection.md)
...
**For comprehensive CSRF documentation including detailed solutions and bypass techniques, see [csrf-quickstart.md](./csrf-quickstart.md)**
...
**For comprehensive SSRF documentation including bypass techniques and cloud exploitation, see [ssrf-quickstart.md](./ssrf-quickstart.md) and [ssrf-cheat-sheet.md](./ssrf-cheat-sheet.md)**
...
**Blacklist Bypass:**
- Alternative IPs: `127.1`, `2130706433`, `0x7f000001`, `[::1]`, `0.0.0.0`
- DNS-based: domain with A record → `0.0.0.0` (bypasses string-based IP validators that skip non-IP hostnames; `0.0.0.0` routes to localhost on Linux)
...
### Key Resources
- [SSRF Quick Start Guide](./ssrf-quickstart.md) - Fast reference for testing and exploitation
