...
#### "Hidden OAuth Attack Vectors" - Security Research
**Author**: James Kettle
...
For quick exploitation techniques, see `oauth-quickstart.md`. For comprehensive testing methodology, see `oauth-cheat-sheet.md`.
