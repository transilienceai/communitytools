...
### Archive Extraction Path Traversal (WinRAR, 7-Zip, etc.)
...
# ZIP format: standard tools may strip "../" but some extractors don't
# Manually craft ZIP with traversal in entry names using struct module
# WinRAR's ZIP extraction may or may not follow traversal (version-dependent)
```
