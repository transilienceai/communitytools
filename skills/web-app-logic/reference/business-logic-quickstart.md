...
Result: $1,337 + ($10 x -134) = $1,337 - $1,340 = -$3
```
...
See also: `business-logic-cheat-sheet.md` for payloads and techniques, `business-logic-resources.md` for CVEs and learning resources.
